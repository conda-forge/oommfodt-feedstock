About oommfodt-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oommfodt-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/joommf/oommfodt

Documentation: http://oommfodt.readthedocs.io
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=715&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oommfodt-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oommfodt` can be installed with `conda`:
...
```
mamba install oommfodt
```

It is possible to list all of the versions of `oommfodt` available on your platform with `conda`:
...
```
mamba search oommfodt --channel conda-forge
```
...
mamba repoquery search oommfodt --channel conda-forge

# List packages depending on `oommfodt`:
mamba repoquery whoneeds oommfodt --channel conda-forge

# List dependencies of `oommfodt`:
mamba repoquery depends oommfodt --channel conda-forge
```
